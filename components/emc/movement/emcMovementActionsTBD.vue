...
/* ======================================================
SAFE SOURCE QUANTITY
====================================================== */

function getSourceQty(productIDX: string, sourceIDX: string) {

  if (!movementMap.value[productIDX]) return 0

  return movementMap.value[productIDX][sourceIDX] || 0
...
<template>
  ...
  <v-card class="movement-drawer">
        ...
        <div class="drawer-content">
          ...
          <div v-for="(items, type) in inventoryItems" :key="type" class="inventory-section">
            ...
            <v-list density="compact">
              ...
              <v-list-item v-for="row in items" :key="row.idx">
    ...
    <div v-if="tab === 'available'" class="drawer-footer">
