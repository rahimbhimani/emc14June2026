...
export interface IemcOrganizationContainerConfigs {
  _id?: string
  organizationId: number
...
const emcOrganizationContainerConfigSchema = new Schema<IemcOrganizationContainerConfigs>({
  organizationId: {
    type: Number,
    required: true,
    unique: true,
...
export const emcOrganizationContainerConfig = models.emcOrganizationContainerConfig || model<IemcOrganizationContainerConfigs>('emcOrganizationContainerConfig', emcOrganizationContainerConfigSchema)
